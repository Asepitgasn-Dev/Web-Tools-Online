...
<html>
    <head>
        <title>CSRF ONLINE KCT</title>
         <link type="text/css" href="http://anicrack-indo.netii.net/error.css" rel="stylesheet"> 
         <audio autoplay> <source src="https://g.top4top.io/m_1624fuh2r1.mp3" type="audio/mpeg"></audio>
                      ...
                      <body style="background-color: rgb(0, 0, 0); color: rgb(0, 0, 0);"alink="#ee0000" link="#0000ee" vlink="#551a8b">
                         <span style="color: rgb(242, 239, 239);">
                            <br>
                               ...
                               <center> 
                               <div class="error">
                                  <img border="0" src="https://h.top4top.io/p_1624k1ogc1.jpg" width="250" height="">
                                     <br>
                                      ...
                                      <br>                                                                         </br>
                                           ...
                                           <font size="7" face="Open Sans Condensed"> Csrf Online</font>
                                           </p>
                                           <font size="4" face="Ubuntu Mono"></font></p>
                                           <font size="5" face="Ubuntu Mono">[ KELELAWAR CYBER TEAM ]</font>
                                           <br>
                                           <br>
                                <div style="display">   
                                               <center>
<form method="post">
<font face="Inconsolata" color="white"> URL TARGET: </font> <font color="red"> &#1203;&#824;&#1202;&#824;&#1203; </font> <input type="text" name="url" placeholder="Target Kamu Sayangku" style="margin: 5px auto; padding-left: 5px;" required>
...
<br><br><input type = "submit" name = "submit" value = "KITA PUTUS" class="login-input"style='width: 130px; height: 40px;'> </ form >
</form>
</form>
