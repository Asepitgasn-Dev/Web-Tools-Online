...
<head>
    ...
    <meta name="description" content="Takdirku Bukan Untuk Memilikimu, Tpi Untuk Mencintaimu dgn bahagia">
    <meta name="keywords" content="Script Deface Generator">
    <link rel="shortcut icon" type="image/x-icon" href="http://al-list.com/favicon.ico" />
...
<center>
    <h1 style="margin-top: 20px;margin-bottom: 50px;">[+] SCRIPT DEFACE GENERATOR KCT [+]</h1>
...
<!-- https://www.google.com/maps/place/-7.7082+114.0008 -->
    ...
    <div class="col-lg-12">
        <div class="row">
                ...
                <table class="table">
                  <tr>
                    <td>
                        ...
                        <input type="text" id="gambar" class="form-control" placeholder="http://al-list.com/gambar.jpg">
                    </td>
                    <td>
                      <label>Warna Background: </label>
                      <input type="text" id="background" class="form-control" placeholder="#00f00 / RED / BLUE">
                    </td>
                    <td>
                ...
                <table class="table">
                  <tr>
                    <td>
                        ...
                        <input type="text" id="nick" class="form-control" placeholder="Hacked By Tn.Error404">
                    </td>
                    <td>
                      <label>Warna : </label>
                      <input type="text" id="warna_nick" class="form-control" placeholder="#00f00 / RED / BLUE">
                    </td>
                    <td>
                ...
                <table class="table">
                  <tr>
                    <td>
                        ...
                        <input type="text" id="tim" class="form-control" placeholder="[ KELELAWAR CYBER TEAM]">
                    </td>
                    <td>
                      <label>Warna : </label>
                      <input type="text" id="warna_tim" class="form-control" placeholder="#00f00 / RED / BLUE">
                    </td>
                    <td>
                      <label>Type Font : </label>
              ...
              <div class="form-group">
                <table class="table">
                  <tr>
                    <td>
                        <label>Kata 1 : </label>
                        <input type="text" id="kata1" class="form-control" placeholder="Dear Admin Sayang :v">
                    </td>
                    <td>
                      <label>Warna : </label>
                      <input type="text" id="warna_kata1" class="form-control" placeholder="#00f00 / RED / BLUE">
                    </td>
                    <td>
                      <label>Type Font : </label>
              ...
              <div class="form-group">
                <table class="table">
                  <tr>
                    <td>
                        <label>Kata 2 : </label>
                        <input type="text" id="kata2" class="form-control" placeholder="Situs Anda Telah Kami Retas">
                    </td>
                    <td>
                      <label>Warna : </label>
                      <input type="text" id="warna_kata2" class="form-control" placeholder="#00f00 / RED / BLUE">
                    </td>
                    <td>
                      <label>Type Font : </label>
              ...
              <div class="form-group">
                <table class="table">
                  <tr>
                    <td>
                        <label>Kata 3 : </label>
                        <input type="text" id="kata3" class="form-control" placeholder="Tn.Error404">
                    </td>
                    <td>
                      <label>Warna : </label>
                      <input type="text" id="warna_kata3" class="form-control" placeholder="#00f00 / RED / BLUE">
                    </td>
                    <td>
                      <label>Type Font : </label>
                ...
                <table class="table">
                  <tr>
                    <td>
                        ...
                        <input type="text" id="thanks" class="form-control" placeholder="Tn.Error404">
                    </td>
                    <td>
                      <label>Warna : </label>
                      <input type="text" id="warna_thanks" class="form-control" placeholder="#00f00 / RED / BLUE">
                    </td>
                    <!-- <td>
                      <label>Nama Samaran (NICK) : </label>
                        <input type="text" id="nick" class="form-control" placeholder="Tn.Error404">
                    </td> -->
                  </tr>
                </table>
              </div>
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                <label>Script : Silahkan Di Copy Beb</label>
    ...
    <div class="col-lg-12" style="margin-bottom: 20px;margin-top: 20px">
        <center>
            <b>KELELAWAR CYBER TEAM-2k19</b>
        </center>
    </div>

<!-- Modal -->
<div id="myModal2" class="modal fade" role="dialog" style="color:#333">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <br><img src="img.png" style="width:100%">
      </div>
